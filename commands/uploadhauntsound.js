...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // TODO: ensure rarity is within bounds
        if (false) {
            interaction.reply({ content: 'The soul rarity is too big or too small, please enter a value between ???', ephemeral: true});
            return;
        }
        ...
        // TODO: Get existing information on souls for the server to check for duplicates, etc.
        ...
        for (let soul of soulsFileContents.souls) {
        ...
        // Download the sound effect. I think it will be stored on Discord's CDN when uploaded to the bot
        // But it cannot be kept there indefinitely
        ...
        const request = https.get(soundAttachment.url, (response) => {
            response.pipe(file);
